execute if score variables.i mypacks.im matches 0 run execute positioned ^ ^ ^ rotated ~30 ~ run function mypacks:move/blood_wings/cast
...
execute if score variables.i mypacks.im matches 2 run execute positioned ^ ^ ^ rotated ~-30 ~ run function mypacks:move/blood_wings/cast
