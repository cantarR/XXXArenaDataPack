...
execute unless block ^ ^ ^1 #ut:ray_trans run scoreboard players set @s plt3 0
execute if score @s plt3 matches 1.. positioned ^ ^ ^0.25 run function mypacks:move/library_of_ruina/snapping/loop_l
execute if score @s plt3 matches 0 if block ~ ~-1 ~ #ut:ray_trans unless entity @a[tag=lor_teleport_target] run function mypacks:move/library_of_ruina/snapping/loop_l2