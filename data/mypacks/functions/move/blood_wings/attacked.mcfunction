...
execute if score #random store matches 2 positioned ^ ^ ^-2 rotated ~-45 20 run function mypacks:move/blood_wings/cast_wings2
execute if score #random store matches 3 positioned ^ ^ ^-2 rotated ~45 -20 run function mypacks:move/blood_wings/cast_wings2
