...
execute unless entity @a[tag=wings_target] run execute store result entity @s[tag=bloodwings] Rotation[0] float 0.00001 run random value -90..90
execute unless entity @a[tag=wings_target] run execute store result entity @s[tag=bloodwings] Rotation[1] float 0.00001 run random value -90..90
