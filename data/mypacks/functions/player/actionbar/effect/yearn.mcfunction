...
data modify storage soul ActionList prepend value '[{"text":"\\uF819\\uF817\\uFF12\\uF812"},{"text":"\\uF801"},{"text":"","font":"minecraft:back.state.small","extra":[{"score":{"objective":"hud","name":"#yearn"}},{"text":"."},{"score":{"objective":"hud","name":"#yearn_ms"}},{"text":"s"}]},{"text":"","font":"minecraft:display","extra":[{"score":{"objective":"hud","name":"#yearn"}},{"text":"."},{"score":{"objective":"hud","name":"#yearn_ms"}},{"text":"s"}]},{"text":"\\uF821\\uF819\\uF815"}]'
