...
execute as @e[tag=atker] at @s run function ut:move/_break/main
...
playsound entity.item.break player @a ~ ~ ~ 0.5 1
particle minecraft:end_rod ~ ~1 ~ 0.25 0.45 0.25 0 16 force @a
