...
execute if score #dodgeAgain plt2 matches 0 at @s positioned ~ ~1.5 ~ facing entity @a[tag=wtk_dodge_player,limit=1] eyes positioned ^ ^ ^.75 run function cua:move/wtk_dodge/trigger/5