...
execute if entity @s[tag=wtk_dodge] run function cua:move/wtk_dodge/stop
execute if entity @s[tag=counter_wtk_dodge] run function cua:move/wtk_dodge/counter/clear
