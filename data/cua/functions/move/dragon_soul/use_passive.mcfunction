...
execute if entity @e[tag=summon,tag=dragon_soul_peach] run function cua:move/wtk_peach/use_suc
execute if entity @e[tag=summon,tag=dragon_soul_dodge] run function cua:move/wtk_dodge/give
