...
data modify block 255 2 255 front_text.messages[0] set value '{"translate":"chr.dell.dtxn","with":[{"selector":"@a[tag=pda_owner]"},{"translate":"chr.dell.dtb"},{"score":{"objective":"temp","name":"#pda_knock"}}]}'
