...
data modify block 255 2 255 front_text.messages[0] set value '{"translate":"chr.dell.dtxn","with":[{"selector":"@a[tag=pda_owner]"},{"translate":"chr.dell.dtc_2"},{"score":{"objective":"temp","name":"#pda_knock"}}]}'
