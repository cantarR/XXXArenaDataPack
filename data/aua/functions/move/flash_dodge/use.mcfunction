...
execute at @s run particle minecraft:dust_color_transition 0.6 0 0.6 1 0 1 4 ~ ~1 ~ 0.4 0.5 0.4 0 16 force @a
execute at @s positioned ^ ^ ^.25 run function aua:move/flash_dodge/step
execute at @s run particle minecraft:dust_color_transition 1 0 1 0.6 0 0.6 4 ~ ~1 ~ 0.4 0.5 0.4 0 16 force @a
