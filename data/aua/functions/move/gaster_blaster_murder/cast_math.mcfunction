...
execute at @s positioned ~ ~1.5 ~ run tp @e[type=marker,tag=gb_murder_target,limit=1] ^ ^ ^8

execute store result score @s x_tar run data get entity @e[type=marker,tag=gb_murder_target,limit=1] Pos[0] 10
execute store result score @s y_tar run data get entity @e[type=marker,tag=gb_murder_target,limit=1] Pos[1] 10
execute store result score @s z_tar run data get entity @e[type=marker,tag=gb_murder_target,limit=1] Pos[2] 10
