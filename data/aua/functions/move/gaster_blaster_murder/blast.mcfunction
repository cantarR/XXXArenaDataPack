...
execute if score @s life matches 33..52 at @s rotated ~ ~15 anchored eyes positioned ^ ^-.2 ^ positioned ^ ^ ^.5 run function aua:move/gaster_blaster_murder/blast_damage