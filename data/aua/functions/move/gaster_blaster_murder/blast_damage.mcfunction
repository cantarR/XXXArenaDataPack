...
execute positioned ^ ^ ^64.5 as @a[tag=playing,distance=..64,tag=!untargetable] unless score @s tid = #atker tid run function aua:move/gaster_blaster_murder/blast_math
