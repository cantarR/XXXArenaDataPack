...
data modify storage ut:soul EffectList prepend value '[{"text":"\\uF819\\uF817\\uF037\\uF812"},{"text":"","font":"minecraft:back.state.small","extra":[{"score":{"objective":"hud","name":"timer037"}},{"text":"."},{"score":{"objective":"hud","name":"timer037_ms"}},{"text":"s"}]},{"text":"","font":"minecraft:display","extra":[{"score":{"objective":"hud","name":"timer037"}},{"text":"."},{"score":{"objective":"hud","name":"timer037_ms"}},{"text":"s"}]},{"text":"\\uF819\\uF815"}]'
