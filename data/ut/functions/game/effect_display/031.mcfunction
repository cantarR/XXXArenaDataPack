...
execute if score @s sadness_level matches 1..5 run data modify storage ut:soul EffectList prepend value '[{"text":"\\uF819\\uF817\\uF031\\uF812"},{"text":"","font":"minecraft:back.state.small","extra":[{"score":{"objective":"hud","name":"timer031"}},{"text":"."},{"score":{"objective":"hud","name":"timer031_ms"}},{"text":"s"}]},{"text":"","font":"minecraft:display","extra":[{"score":{"objective":"hud","name":"timer031"}},{"text":"."},{"score":{"objective":"hud","name":"timer031_ms"}},{"text":"s"}]},{"text":"\\uF801"},{"font":"minecraft:back.state.small","score":{"objective":"sadness_level","name":"@s"}},{"font":"display.even.lower","score":{"objective":"sadness_level","name":"@s"}},{"text":"\\uF821\\uF819\\uF815"}]'

execute unless score @s sadness_level matches 1..5 run data modify storage ut:soul EffectList prepend value '[{"text":"\\uF819\\uF817\\uF032\\uF812"},{"text":"","font":"minecraft:back.state.small","extra":[{"score":{"objective":"hud","name":"timer031"}},{"text":"."},{"score":{"objective":"hud","name":"timer031_ms"}},{"text":"s"}]},{"text":"","font":"minecraft:display","extra":[{"score":{"objective":"hud","name":"timer031"}},{"text":"."},{"score":{"objective":"hud","name":"timer031_ms"}},{"text":"s"}]},{"text":"\\uF819\\uF815"}]'
