...
data modify storage ut:soul EffectList prepend value '[{"text":"\\uF819\\uF817\\uF024\\uF812"},{"text":"","font":"minecraft:back.state.small","extra":[{"score":{"objective":"hud","name":"timer024"}},{"text":"."},{"score":{"objective":"hud","name":"timer024_ms"}},{"text":"s"}]},{"text":"","font":"minecraft:display","extra":[{"score":{"objective":"hud","name":"timer024"}},{"text":"."},{"score":{"objective":"hud","name":"timer024_ms"}},{"text":"s"}]},{"text":"\\uF819\\uF815"}]'
