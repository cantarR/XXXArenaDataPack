...
data modify storage ut:soul EffectList prepend value '[{"text":"\\uF819\\uF817\\uF053\\uF812"},{"text":"","font":"minecraft:back.state.small","extra":[{"score":{"objective":"hud","name":"timer0172"}},{"text":"."},{"score":{"objective":"hud","name":"timer0172_ms"}},{"text":"s"}]},{"text":"","font":"minecraft:display","extra":[{"score":{"objective":"hud","name":"timer0172"}},{"text":"."},{"score":{"objective":"hud","name":"timer0172_ms"}},{"text":"s"}]},{"text":"\\uF821\\uF819\\uF815"}]'
