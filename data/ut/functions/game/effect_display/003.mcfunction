...
data modify storage ut:soul EffectList prepend value '[{"text":"\\uF819\\uF817\\uF003\\uF812"},{"text":"","font":"minecraft:back.state.small","extra":[{"score":{"objective":"hud","name":"timer003"}},{"text":"."},{"score":{"objective":"hud","name":"timer003_ms"}},{"text":"s"}]},{"text":"","font":"minecraft:display","extra":[{"score":{"objective":"hud","name":"timer003"}},{"text":"."},{"score":{"objective":"hud","name":"timer003_ms"}},{"text":"s"}]},{"text":"\\uF819\\uF815"}]'
