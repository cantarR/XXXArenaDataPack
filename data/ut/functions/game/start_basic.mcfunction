...
execute as @a[tag=play_game] if score #effectdisplay flag matches 1.. run function ut:game/effect_display/create

execute as @a[tag=play_game] run function mypacks:game/start_basic