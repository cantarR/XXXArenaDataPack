...
execute as @e[tag=team_attack,scores={maplock=1},limit=1] at @s run function ut:game/team/spawnpoint
execute as @e[tag=team_defend,scores={maplock=1},limit=1] at @s run function ut:game/team/spawnpoint
