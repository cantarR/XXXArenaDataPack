...
execute if score pc store matches 2.. if entity @a[tag=winner,scores={tid=9}] run tellraw @a ["",{"translate":"pfx.game"},{"translate":"cht.gm2","with":[{"translate":"tem.9","color":"#95b300"}]}]
execute if score pc store matches 2.. if entity @a[tag=winner,scores={tid=10}] run tellraw @a ["",{"translate":"pfx.game"},{"translate":"cht.gm2","with":[{"translate":"tem.10","color":"#e65c00"}]}]
execute if score pc store matches 2.. if entity @a[tag=winner,scores={tid=11}] run tellraw @a ["",{"translate":"pfx.game"},{"translate":"cht.gm2","with":[{"translate":"tem.11","color":"#ffbf00"}]}]
execute if score pc store matches 2.. if entity @a[tag=winner,scores={tid=12}] run tellraw @a ["",{"translate":"pfx.game"},{"translate":"cht.gm2","with":[{"translate":"tem.12","color":"#b31500"}]}]
