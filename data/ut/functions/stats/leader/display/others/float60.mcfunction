...
tellraw @a[tag=seelbdisplay,tag=!lb_playing] [{"text":"|| ","color":"gold"},{"text":"","color":"gray","extra":[{"score":{"name":"@s","objective": "leaderboard_rank"}},". ",{"selector":"@s"}," - ",{"score":{"name":"out4p","objective":"damage"}},{"score":{"name":"out4","objective":"damage"}},{"text":":"},{"score":{"name":"out3p","objective":"damage"}},{"score":{"name":"out3","objective":"damage"}},{"text":":"},{"score":{"name":"out2p","objective":"damage"}},{"score":{"name":"out2","objective":"damage"}}]}]
