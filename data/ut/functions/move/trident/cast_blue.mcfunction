...
data merge entity @e[tag=summon,limit=1] {Tags:[summon,move,prj_sp,trident,trident_blue],NoGravity:1b,Invulnerable:1b,Silent:1b,NoAI:1b,ArmorItems:[{},{},{id:"minecraft:slime_ball",Count:1b,tag:{hit_list:[]}},{}],CustomNameVisible:0b,Team:"nocol"}
