...
execute if score #soultype store matches 1 run team join c9 @e[tag=summon,limit=1,type=armor_stand]
execute if score #soultype store matches 2 run team join c10 @e[tag=summon,limit=1,type=armor_stand]
execute if score #soultype store matches 3 run team join c11 @e[tag=summon,limit=1,type=armor_stand]
execute if score #soultype store matches 4 run team join c12 @e[tag=summon,limit=1,type=armor_stand]
execute if score #soultype store matches 5 run team join c13 @e[tag=summon,limit=1,type=armor_stand]
execute if score #soultype store matches 6 run team join c14 @e[tag=summon,limit=1,type=armor_stand]
execute if score #soultype store matches 7 run team join c15 @e[tag=summon,limit=1,type=armor_stand]
execute if score #soultype store matches 8 run team join c16 @e[tag=summon,limit=1,type=armor_stand]
