...
execute as @a[tag=playing,tag=!untargetable,distance=..2.5,sort=nearest] unless score @s tid = #atker tid positioned ^ ^ ^-1.2 run function ut:move/paper_plane/hitcheck
tag @s remove atker
