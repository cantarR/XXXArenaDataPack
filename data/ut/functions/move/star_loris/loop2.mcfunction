...
execute as @e[tag=st_center] if score @s pid = #player pid at @s positioned ~ ~ ~ run execute as @e[tag=star_loris,tag=st1] if score @s pid = #player pid run tp @s ^ ^ ^1.6
execute as @e[tag=st_center] if score @s pid = #player pid at @s positioned ~ ~ ~ run execute as @e[tag=star_loris,tag=st2] if score @s pid = #player pid run tp @s ^1.384 ^ ^-1
execute as @e[tag=st_center] if score @s pid = #player pid at @s positioned ~ ~ ~ run execute as @e[tag=star_loris,tag=st3] if score @s pid = #player pid run tp @s ^-1.384 ^ ^-1
