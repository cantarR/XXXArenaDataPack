...
execute as @e[tag=star_loris_center] if score @s life matches 150.. run execute as @e[tag=star_loris_01] if score @s pid = #player pid at @a[limit=1,tag=star_owner] run tp @s ^ ^1 ^ ~ ~
execute as @e[tag=star_loris_center] if score @s life matches 150.. run execute as @e[tag=star_loris_02] if score @s pid = #player pid at @a[limit=1,tag=star_owner] run tp @s ^0.3 ^1 ^ ~ ~
execute as @e[tag=star_loris_center] if score @s life matches 150.. run execute as @e[tag=star_loris_03] if score @s pid = #player pid at @a[limit=1,tag=star_owner] run tp @s ^-0.3 ^1 ^ ~ ~
