tag @s add snh_shadowblade_user
...
execute if entity @s[tag=!hp_lock] run function ut:move/snh_shadowblade/extra
playsound entity.ender_dragon.hurt player @a ~ ~ ~ 1 0.75
