particle dust_color_transition 0 0 0 1 0.518 0 1 ~ ~1 ~ 0.4 0.4 0.4 0.05 5 force @a[scores={Q=2..}]
particle dust_color_transition 0 0 0 1 0.518 0 1 ~ ~1 ~ 0.4 0.4 0.4 0.05 5 force @a[scores={Q=3..}]
