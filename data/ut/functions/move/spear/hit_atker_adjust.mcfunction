...
execute if entity @a[tag=target,limit=1,dx=1,dy=4,dz=1] positioned ~.5 ~ ~.5 if entity @a[tag=target,limit=1,dx=1,dy=4,dz=1] store result score #suc store run tp @s ~ ~ ~
