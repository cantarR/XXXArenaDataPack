...
execute if score @s magic_bullet_count matches 4..6 run tag @p[tag=!filled_bullet] add extra_bullet_target
...
execute as @e[tag=magic_bullet_extra] run spreadplayers ~ ~ 5 10 false @e[tag=magic_bullet_extra]
execute as @e[tag=magic_bullet_extra] at @e[tag=magic_bullet_extra] run tp @s ~ ~-32 ~ facing entity @p[tag=extra_bullet_target] feet
...
scoreboard players set @e[tag=inited] magic_bullet_timer 30
