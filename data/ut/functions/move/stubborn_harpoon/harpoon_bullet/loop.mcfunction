...
execute facing entity @s eyes run function ut:move/stubborn_harpoon/harpoon_bullet/_sys/movement
###HITCHECK
scoreboard players set #hits hitcheck 1
execute if score #stop speed matches 1.. run function ut:move/stubborn_harpoon/harpoon_bullet/hitcheck
###RANGE
