...
scoreboard players set @s speed 30
scoreboard players set @s gravity 30
...
tp @s ~ ~ ~ ~ ~
tag @s remove summon
execute at @s run function ut:move/stubborn_harpoon/harpoon_bullet/_sys/cast_motion