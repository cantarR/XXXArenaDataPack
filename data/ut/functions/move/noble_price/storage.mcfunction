...
item replace entity @a[tag=ego_efflorescer] weapon.offhand with carrot_on_a_stick{ahab_ego:1b,CustomModelData:10907,display:{Name:'{"text":"","color":"yellow","bold":true,"extra":[{"translate":"chr.ahab.ego","italic":false,"color":"white"}]}',Lore:['{"translate":"dsc.dtmove","italic":false,"color":"red"}','{"text":""}','{"translate":"chr.ahab.ego1","italic":false,"color":"white","with":[{"selector":"@s[tag=ego_owner]"}]}','{"translate":"chr.ahab.ego2","italic":false,"color":"white"}','{"translate":"chr.ahab.ego3","italic":false,"color":"white","with": [{"selector":"@s[tag=ego_owner]"}]}','{"translate":"chr.ahab.ego4","italic":false,"color":"white"}','{"translate":"chr.ahab.ego5","italic":false,"color":"white"}']},AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Slot:"offhand",Amount:-10.0d,Operation:0,UUID:[I; 3249, 753, 26789, 26048]}],HideFlags:127}
