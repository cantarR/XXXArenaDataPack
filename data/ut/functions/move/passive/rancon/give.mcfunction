...
execute as @a[tag=atker_p,tag=passive_rancon] as @s[tag=passive_rancon] if score @s count_a matches 3 run scoreboard players remove @s will 1
...
execute as @s[tag=passive_rancon] if score @s count_a matches 3 run scoreboard players remove @s will 1
