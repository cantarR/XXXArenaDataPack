...
#09/09/2023, 21:19:36
function ut:move/bomb/explode
execute as @a[distance=..2,tag=inflatoring] run tag @s remove inflatoring
###PARTICLE
particle block lava ^ ^ ^-1 0.1 0.05 0.1 0.1 40 normal @a[scores={Q=2..}]
###MAIN
