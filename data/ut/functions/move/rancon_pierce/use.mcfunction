...
execute as @s at @s anchored eyes positioned ^ ^-.3 ^ if score @s use_count matches 2 run function ut:move/rancon_pierce/particle2
execute as @s at @s anchored eyes positioned ^ ^-.3 ^ if score @s use_count matches 3 run function ut:move/rancon_pierce/particle3
