...
execute as @a[tag=playing,tag=!untargetable,distance=..2,sort=nearest,tag=effect_noise_despair] unless score @s tid = #atker tid run execute as @a if score @s pid = #atker pid run scoreboard players add @s atk 33
...
execute as @a[tag=playing,tag=!untargetable,distance=..2,sort=nearest,tag=effect_noise_despair] unless score @s tid = #atker tid run execute as @a if score @s pid = #atker pid run scoreboard players remove @s atk 33
