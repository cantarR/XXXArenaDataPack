...
execute as @a[tag=rancon_kill] run execute as @a if score @s pid = #player pid run function ut:move/rancon_pierce/killed
execute as @a[tag=rancon_kill] run tag @a remove rancon_kill