...
summon minecraft:marker ~ ~ ~ {Tags:[atker,rancon_pierce,user_direction],CustomName:'{"translate":"chr.rancon.mpn"}'}
...
execute if entity @s[tag=rancon_pierce_user] anchored eyes facing ^ ^ ^16 positioned ^ ^-0.2 ^ run function ut:move/rancon_pierce/loop_l
