...
execute unless score A_Bonus gamerulemode matches 0..4 run scoreboard players set A_Bonus gamerulemode 0
...
execute if score A_Bonus gamerulemode matches 4 run tellraw @s ["",{"translate":"pfx.settings"},{"translate":"set.grkb","with":[{"translate":"set.grdr.3"}]}]
