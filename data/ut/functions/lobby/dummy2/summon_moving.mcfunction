...
summon minecraft:armor_stand ~ ~ ~ {Marker:0b,Tags:[moving,lobby_as,active,ray_target,ray_dummy2,dummy,summon],Invisible:0b,Invulnerable:1b,NoGravity:1b,DisabledSlots:3620671}
...
execute as @e[tag=summon,limit=1,type=armor_stand] positioned as @s run tp @s ~ ~ ~ ~ ~
