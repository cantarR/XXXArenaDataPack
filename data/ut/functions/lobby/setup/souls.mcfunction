...
execute positioned ^-7 ^2 ^-5 run function ut:lobby/setup/soul
data merge entity @e[tag=summon,limit=1] {CustomName:'["",{"translate":"tem.9","color":"red"}]'}
scoreboard players set @e[tag=summon] ptid 9
execute as @e[tag=summon] positioned as @s run tp @s ~ ~ ~ ~ ~
tag @e[tag=summon] remove summon

execute positioned ^19 ^2 ^0 run function ut:lobby/setup/soul
data merge entity @e[tag=summon,limit=1] {CustomName:'["",{"translate":"tem.10","color":"light_purple"}]'}
scoreboard players set @e[tag=summon] ptid 10
execute as @e[tag=summon] positioned as @s run tp @s ~ ~ ~ ~90 ~
tag @e[tag=summon] remove summon

execute positioned ^-14 ^2 ^-5 run function ut:lobby/setup/soul
data merge entity @e[tag=summon,limit=1] {CustomName:'["",{"translate":"tem.11","color":"gold"}]'}
scoreboard players set @e[tag=summon] ptid 11
execute as @e[tag=summon] positioned as @s run tp @s ~ ~ ~ ~ ~
tag @e[tag=summon] remove summon

execute positioned ^14 ^2 ^-5 run function ut:lobby/setup/soul
data merge entity @e[tag=summon,limit=1] {CustomName:'["",{"translate":"tem.12","color":"blue"}]'}
scoreboard players set @e[tag=summon] ptid 12
execute as @e[tag=summon] positioned as @s run tp @s ~ ~ ~ ~ ~
tag @e[tag=summon] remove summon

execute positioned ^7 ^2 ^-5 run function ut:lobby/setup/soul
data merge entity @e[tag=summon,limit=1] {CustomName:'["",{"translate":"tem.13","color":"aqua"}]'}
scoreboard players set @e[tag=summon] ptid 13
execute as @e[tag=summon] positioned as @s run tp @s ~ ~ ~ ~ ~
tag @e[tag=summon] remove summon

execute positioned ^-19 ^2 ^7 run function ut:lobby/setup/soul
data merge entity @e[tag=summon,limit=1] {CustomName:'["",{"translate":"tem.14","color":"green"}]'}
scoreboard players set @e[tag=summon] ptid 14
execute as @e[tag=summon] positioned as @s run tp @s ~ ~ ~ ~-90 ~
tag @e[tag=summon] remove summon

execute positioned ^-19 ^2 ^0 run function ut:lobby/setup/soul
data merge entity @e[tag=summon,limit=1] {CustomName:'["",{"translate":"tem.15","color":"yellow"}]'}
scoreboard players set @e[tag=summon] ptid 15
execute as @e[tag=summon] positioned as @s run tp @s ~ ~ ~ ~-90 ~
tag @e[tag=summon] remove summon

execute positioned ^19 ^2 ^7 run function ut:lobby/setup/soul
data merge entity @e[tag=summon,limit=1] {CustomName:'["",{"translate":"tem.16","color":"white"}]'}
