...
execute if score #butsoul soul matches 3 run tellraw @s [{"translate":"stut.r8.e2.s11"}]
execute if score #butsoul soul matches 4 run tellraw @s [{"translate":"stut.r8.e2.s12"}]
execute if score #butsoul soul matches 5 run tellraw @s [{"translate":"stut.r8.e2.s13"}]
execute if score #butsoul soul matches 6 run tellraw @s [{"translate":"stut.r8.e2.s14"}]
execute if score #butsoul soul matches 7 run tellraw @s [{"translate":"stut.r8.e2.s15"}]
execute if score #butsoul soul matches 8 run tellraw @s [{"translate":"stut.r8.e2.s16"}]
