...
execute if score #butsoul soul matches 9 run tellraw @s [{"translate":"pfx.tut"},{"translate":"stut.r8.e2.2","with":[{"translate": "tem.9", "color":"#95b300"}]}]
execute if score #butsoul soul matches 10 run tellraw @s [{"translate":"pfx.tut"},{"translate":"stut.r8.e2.2","with":[{"translate": "tem.10", "color":"#e65c00"}]}]
execute if score #butsoul soul matches 11 run tellraw @s [{"translate":"pfx.tut"},{"translate":"stut.r8.e2.2","with":[{"translate": "tem.11", "color":"#ffbf00"}]}]
execute if score #butsoul soul matches 12 run tellraw @s [{"translate":"pfx.tut"},{"translate":"stut.r8.e2.2","with":[{"translate": "tem.12", "color":"#b31500"}]}]
...
execute if score #butsoul soul matches 9 run tellraw @s [{"translate":"stut.r8.e2.s9"}]
execute if score #butsoul soul matches 10 run tellraw @s [{"translate":"stut.r8.e2.s10"}]
execute if score #butsoul soul matches 11 run tellraw @s [{"translate":"stut.r8.e2.s11"}]
execute if score #butsoul soul matches 12 run tellraw @s [{"translate":"stut.r8.e2.s12"}]
execute if score #butsoul soul matches 13 run tellraw @s [{"translate":"stut.r8.e2.s13"}]
execute if score #butsoul soul matches 14 run tellraw @s [{"translate":"stut.r8.e2.s14"}]
execute if score #butsoul soul matches 15 run tellraw @s [{"translate":"stut.r8.e2.s15"}]
execute if score #butsoul soul matches 16 run tellraw @s [{"translate":"stut.r8.e2.s16"}]
