...
scoreboard players set #join tut_sr 18
execute if score @s gamesfinished >= #join tut_sr if score @s tut_sr >= #join tut_sr run function ut:lobby/tutorial/s/r6/join_suc
