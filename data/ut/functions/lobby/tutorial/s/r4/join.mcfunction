...
scoreboard players set #join tut_sr 12
execute if score @s gamesfinished >= #join tut_sr if score @s tut_sr >= #join tut_sr run function ut:lobby/tutorial/s/r4/join_suc
