...
execute unless score pl store matches 1.. run scoreboard players set pl store 32
execute if score tl store matches ..1 run tellraw @s ["",{"translate":"pfx.warning"},{"translate":"cht.set4"}]
execute unless score tl store matches 2..16 run scoreboard players set tl store 16
