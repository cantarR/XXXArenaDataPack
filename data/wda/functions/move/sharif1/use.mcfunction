...
execute as @s[tag=!attack_buffed, tag=sharif3_user] unless score @s plt1 matches 4 positioned ^ ^ ^ anchored eyes run function wda:move/sharif1/cast

execute as @s[tag=!attack_buffed, tag=sharif3_user] if score @s plt1 matches 4 positioned ^ ^ ^ facing ^ ^ ^10 anchored eyes run function wda:move/sharif1/cast
execute as @s[tag=!attack_buffed, tag=sharif3_user] if score @s plt1 matches 4 positioned ^-.2 ^ ^ facing ^-.4 ^ ^10 anchored eyes run function wda:move/sharif1/cast
execute as @s[tag=!attack_buffed, tag=sharif3_user] if score @s plt1 matches 4 positioned ^.2 ^ ^ facing ^.4 ^ ^10 anchored eyes run function wda:move/sharif1/cast
...
execute unless score @s plt1 matches 4 at @s run tp @s ~ ~ ~ ~ ~-4
execute if score @s plt1 matches 4 at @s run tp @s ~ ~ ~ ~ ~-10
function ut:player/infight/use
scoreboard players reset @s[scores={plt1=4..}] plt1